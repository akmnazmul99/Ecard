...
public class CompleteProfile extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.complete_profile_toolbar);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.complete_profile_nav_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.card_search) {
            ...
            Intent create_card_intent = new Intent(CompleteProfile.this, CardInfoManualUpdate.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(CompleteProfile.this, SingleContact.class);
            startActivity(nav_profile_intent);

        } else if (id == R.id.nav_all_cantacts) {
            Intent nav_all_cantacts_intent = new Intent(CompleteProfile.this, AllContacts.class);
            startActivity(nav_all_cantacts_intent);
        }
        else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(CompleteProfile.this, AllCards.class);
            startActivity(nav_all_cards_intent);

        }
        else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(CompleteProfile.this, Settings.class);
